...
/**
 * The MoneyTransfer context holds the immutable state, in this case the Accounts (which are also immutable).
 *
 * Doing a money transfer involves creating and invoking functions that produce a new MoneyTransfer context with new
 * Account state.
 */
public class MoneyTransfer {
    ...
    /**
     * Create a function which given a MoneyTransfer can create a function to receive a transfer and produce a new
     * MoneyTransfer state
     *
     * @return
     */
